...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        glow: '0 0 42px rgba(255, 98, 75, 0.35)',
      ...
      backgroundImage: {
        aurora:
          'radial-gradient(circle at 30% 15%, rgba(255,98,75,.2), transparent 30%), radial-gradient(circle at 80% 0%, rgba(255,138,61,.14), transparent 22%), linear-gradient(180deg, #05080c 0%, #05080c 46%, #070d13 100%)',
      },
      keyframes: {
        float: {
